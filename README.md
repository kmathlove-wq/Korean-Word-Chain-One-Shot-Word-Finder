...
전체 과정은 20초 안에서만 진행합니다. 그 안에 다 못 끝냈으면 그때까지 확인한 결과만 보여 주고 "시간이 부족해 일부 후보를 확인하지 못했습니다. 같은 글자로 다시 검색하면 이어서 더 찾아냅니다."라는 안내가 함께 나옵니다. 같은 글자로 다시 검색하면 그새 데워진 캐시 덕분에 더 많이 확인됩니다.
