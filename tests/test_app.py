...
class HelperTests(unittest.TestCase):
    def test_dueum_and_last_syllable(self):
        ...
        self.assertEqual(app.get_dueum_variants("락"), ["락"])
        self.assertEqual(app.get_dueum_variants("랑"), ["랑"])
        self.assertEqual(app.get_dueum_variants("렌"), ["렌"])
        self.assertEqual(app.get_dueum_variants("린"), ["린"])
        self.assertEqual(app.get_dueum_variants("륨"), ["륨"])
    ...
    def test_fast_analysis_does_not_change_ryum_to_yum(self):
        ...
        self.assertEqual(analysed[0]["next_word_count"], 0)
